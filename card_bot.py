...
bot = TeleBot(token='5934504725:AAHQb5xTgWW5nLzbEOjROi2Rwn4DiCyrai4', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Hi! Choose the type of card you want to generate:', # текст сообщения
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message(
            ...
            text="Unfortunately, I don't understand you :("
        )
        return
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text=f'Your test card: {card_type}:\n<code>{card_number}</code>'
    )
